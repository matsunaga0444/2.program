...
for i_q in range(n0-1):
    plt.scatter(kBTs, coherence_length_GL_formulation_square(ans_a[(i_q+1),0,:,0], ans_a[0,0,:,0], qs[(i_q+1)]),5 ,marker= "o")
    #plt.scatter(kBTs, c_l_puterbation_extended_GL_square(a, b, d[i_q]*ones(1), e[i_q]*ones(1)), 5,marker= "o" ,label = r'$\xi^2$ in modified method')
