...
xi = []
for i in range(n_U):
    ans = Gap_equation_SC_BCS_1D.scf_1D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mu, gu, Bs, Us[i])
    xi_Ex_GL    = coherence_length_1D.coherence_length_from_extended_GL_theory_1D(t, mu, gu, Bs[0], kBTs[0], Us[i], N, dq, ans[0,0,0,0])
    xi.append(xi_Ex_GL)
xi = array(xi)
