...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =30, 2, 1 , 0.1, 1, 2, 1, 100, 2000  # 7.525 #9.21
...
kBTs = linspace(0.001,0.206,n2)

ans = Gap_equation_SC_BCS_3D.scf_3D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mu, gu, Bs, V)

lamb = []
for i in range(n2):
    xi_GL    = coherence_length_3D.gap_to_xi_3D(ans[0,0,i,0], ans[1,0,i,0], dq)
    lamb_GL = penetration_depth_SC_3D.penetration_depth_GL(xi_GL, dq, kBTs[i], ini_gap, nscf, N, t, mu, gu, Bs[0], V)
    lamb.append(lamb_GL)
lamb = array(lamb)
