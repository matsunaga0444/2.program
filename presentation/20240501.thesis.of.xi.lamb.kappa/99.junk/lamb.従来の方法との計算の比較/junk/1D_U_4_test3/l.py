...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =2000, 3, 1 , 0.1, 1, 1, 1, 100, 2000  # 7.525 #9.21
...
lamb = []
for i in range(n2):
    lamb_linear = penetration_depth_SC_1D.penetration_depth_linear_1D(t, mu, 1/kBTs[i], N, ans[0,0,i,0])
...
plt.savefig("lamb_linear_2000.png")
plt.clf()

###################################
##output
file = open("lamb_linear_2000", "w")
for i in range(n2):
