...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =10000, 2, 1 , 0, 1, 2, 1, 100, 2000  # 7.525 #9.21
...
kBTs = linspace(0.075,0.2,n2)

xi = []
for i in range(n2):
    xi_GL    = free_energy_SC_BCS_1D.d6f_1D(t, mu, gu, Bs[0], 1/kBTs[i], V, N, 0, 0.001)
    xi.append(xi_GL)
xi = array(xi)
