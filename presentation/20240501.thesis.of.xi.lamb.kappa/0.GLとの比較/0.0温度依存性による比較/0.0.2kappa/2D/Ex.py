...
from SC_kappa import kappa_2D

##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =100, 2, 1 , 0, 1, 1, 1, 100, 2000  # 7.525 #9.21
...
kBTs = linspace(0.001,0.21,n2)

ans = Gap_equation_SC_BCS_2D.scf_2D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mu, gu, Bs, V)

xi = []
for i in range(n2):
    xi_Ex_GL    = kappa_2D.kappa_from_Ex_GL_2D(t, mu, gu, Bs[0], kBTs[i], V, N, ans[0,0,i,0], dq)
    xi.append(xi_Ex_GL)
xi = array(xi)
