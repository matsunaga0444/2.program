...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =30, 2, 1 , 0.1, 1, 1, 1, 100, 2000  # 7.525 #9.21
...
lamb = []
for i in range(n2):
    lamb_Ex_GL = penetration_depth_SC_3D.penetration_depth_from_extended_GL_3D(t, mu, gu, Bs[0], 1/kBTs[i], V, N, ans[0,0,i,0], dq)
...
plt.savefig("lamb_Ex_GL.png")
plt.clf()

###################################
##output
file = open("lamb_Ex_GL", "w")
for i in range(n2):
