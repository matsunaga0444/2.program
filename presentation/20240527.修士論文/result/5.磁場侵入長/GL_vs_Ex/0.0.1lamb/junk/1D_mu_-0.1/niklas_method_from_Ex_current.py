...
for i in range(n2):
    ...
    lamb_Ex_GL = penetration_depth_SC_1D.penetration_depth_Extended_GL(xi_GL, dq, kBTs[i], ini_gap, nscf, N, t, mu, gu, Bs[0], V)
...
plt.savefig("lamb_niklas_Ex_GL.png")
plt.clf()

###################################
##output
file = open("lamb_niklas_Ex_GL", "w")
for i in range(n2):
