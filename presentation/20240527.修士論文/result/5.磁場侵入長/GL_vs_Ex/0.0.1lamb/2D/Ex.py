...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =100, 2, 1 , 0.1, 1, 1, 1, 100, 2000  # 7.525 #9.21
...
lamb = []
for i in range(n2):
    lamb_Ex_GL = penetration_depth_SC_2D.penetration_depth_from_extended_GL_2D(t, mu, gu, Bs[0], 1/kBTs[i], V, N, ans[0,0,i,0], dq)
