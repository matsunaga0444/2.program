...
from SC_penetration_depth import penetration_depth_SC_1D_free

##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =3000, 2, 1 , 0.1, 1, 1, 1, 100, 2000  # 7.525 #9.21
...
kBTs = linspace(0.001,0.1,n2)

ans = Gap_equation_SC_BCS_1D_free.scf_1D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mu, gu, Bs, V)

print(ans)

lamb = []
for i in range(n2):
    lamb_linear = penetration_depth_SC_1D_free.penetration_depth_linear_1D(t, mu, 1/kBTs[i], N, ans[0,0,i,0])
...
plt.savefig("lamb_linear.png")
plt.clf()

###################################
##output
file = open("lamb_linear", "w")
for i in range(n2):
