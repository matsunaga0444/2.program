...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =1000, 1, 1 , 0, 1, 100, 1, 1, 2000  # 7.525 #9.21
...
plt.savefig("q_gap_1D_kBT_0.006.png")
plt.clf()

###################################
##output
file = open("q_gap_1D_kBT_0.006", "w")
for i in range(n0):
