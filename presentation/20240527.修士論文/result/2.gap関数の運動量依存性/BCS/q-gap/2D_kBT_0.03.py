...
dq = 0.001
ini_gap = 100
qs   = linspace(0,0.025,n0)         #(np.pi/a)
Bs   = linspace(0.0,0.0,n1)          #np.linspace(0,0.08,n1)
kBTs = linspace(0.03,0.025,n2)

gap = []
gap    = Gap_equation_SC_BCS_2D.scf_2D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mu, gu, Bs, V)
...
plt.savefig("q_gap_2D_kBT_0.03.png")
plt.clf()

###################################
##output
file = open("q_gap_2D_kBT_0.03", "w")
for i in range(n0):
