...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =10000, 2, 1 , 0, 1, 1, 1, 1, 2000  # 7.525 #9.21
...
n_mu = 100
mus = linspace(-2,2,n_mu)

xi = []
for i in range(n_mu):
    ans = Gap_equation_SC_BCS_1D.scf_1D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mus[i], gu, Bs, V)
    xi_Ex_GL    = coherence_length_1D.coherence_length_from_extended_GL_theory_1D(t, mu, gu, Bs[0], kBTs[0], V, N, dq, ans[0,0,0,0])
    xi.append(xi_Ex_GL)
xi = array(xi)
