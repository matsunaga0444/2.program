...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =30, 2, 1 , 0, 1, 1, 1, 1, 2000  # 7.525 #9.21
...
xi = []
for i in range(n_U):
    ans = Gap_equation_SC_BCS_3D.scf_3D(n0, n1, n2, kBTs, ini_gap, nscf, N, t, qs, mu, gu, Bs, Us[i])
    xi_Ex_GL    = coherence_length_3D.coherence_length_from_extended_GL_theory_3D(t, mu, gu, Bs[0], kBTs[0], Us[i], N, dq, ans[0,0,0,0])
    xi.append(xi_Ex_GL)
xi = array(xi)
