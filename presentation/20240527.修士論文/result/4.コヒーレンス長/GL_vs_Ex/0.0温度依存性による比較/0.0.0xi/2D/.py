...
##パラメータの調整
N, V, t, mu, gu, n0, n1, n2, nscf =100, 2, 1 , 0, 1, 2, 1, 100, 2000  # 7.525 #9.21
...
xi = []
for i in range(n2):
    xi_GL    = coherence_length_2D.coherence_length_from_GL_theory_2D(dq, kBTs[i], ini_gap, nscf, N, t, mu, gu, Bs[0], V)
    xi.append(xi_GL)
xi = array(xi)
