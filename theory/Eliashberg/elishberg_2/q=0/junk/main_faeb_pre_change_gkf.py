...
class fmc_anisotropic_eliashberg_BCS:
    ...
    def scf(self, g, b, p):
        ...
        for n in range(100):
            ...
            self.y_kf_delta = (self.y_kl_delta.T @ b.uhat_F).T / self.zeta
    ...
    def set_frt_zeta(self, g, b, p):
        _ = (1/g.gkf_p + self.chi) *(1/conj(g.gkf_m) + self.chi) + self.delta*conj(self.delta)
    ...
    def set_frt_delta(self, g, b, p):
        _ = 1/(g.gkf_p*conj(g.gkf_m)) + self.delta*conj(self.delta)
        self.fkf_delta = self.delta * self.zeta/_
