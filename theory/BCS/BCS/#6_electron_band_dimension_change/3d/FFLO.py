...
###################################################################################################################
##パラメータの調整(3d)
N, V, t, mu, gu, n0, n1, n2, nscf =100, 1, 1, 0, 1, 1, 1, 10, 2000  #kBT-gap_in_each_q
#N, V, t, mu, gu, n0, n1, n2, nscf =100, 1, 1, 0, 1, 10, 1, 1, 2000  #q-gap_in_each_kBT
qs   = np.linspace(0.0,0.003,n0)        
Bs   = np.linspace(0.0,0.0,n1)     
kBTs = np.linspace(0.0001,0.006,n2)
